...
| `BERTugues` | BERTugues: A Novel BERT Transformer Model Pre-trained for Brazilian Portuguese | [![Paper](https://img.shields.io/badge/UEL-link?color=green)](https://ojs.uel.br/revistas/uel/index.php/semexatas/article/view/50630) | [![Hugging Face](https://img.shields.io/badge/Hugging%20Face-FFD21E?logo=huggingface&logoColor=000)](https://huggingface.co/ricardoz/BERTugues-base-portuguese-cased) |
...
| `moBERTo` | moBERTo: A Modern Encoder for Portuguese via Continued Pretraining of ModernBERT | [![Paper](https://img.shields.io/badge/paper-A42C25?style=for-the-badge&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2606.22722v1) | [![Hugging Face](https://img.shields.io/badge/Hugging%20Face-FFD21E?logo=huggingface&logoColor=000)](https://huggingface.co/Tropic-AI/moBERTo) |
